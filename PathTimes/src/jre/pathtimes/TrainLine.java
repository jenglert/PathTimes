...
public enum TrainLine {
	...
	TTRD_HOB_WEEKDAY(
			new Station[] { Station.ThirtyThird, Station.TwentyThird,
					...
					Station.Hoboken },
			new String[] { "06:40 AM", "06:50 AM", "07:00 AM", "07:10 AM",
	...
	TTRD_JSQ_VIA_HOB_SAT(
			new Station[] { Station.ThirtyThird, Station.TwentyThird,
					Station.Fourteenth, Station.Nineth, Station.Christopher,
					Station.Hoboken, Station.Pavonia, Station.GroveSt,
					Station.JournalSquare }, new String[] { "12:00 AM",
	...
	TTRD_JSQ_WEEKDAY(
			new Station[] { Station.ThirtyThird, Station.TwentyThird,
					...
					Station.JournalSquare }, new String[] { "06:27 AM", "06:37 AM",
	...
	JSQ_TTRD_VIA_HOB_SAT(new Station[] {
			...
			new String[] { "12:15 AM", "12:45 AM", "01:20 AM", "01:55 AM",
					"02:30 AM", "03:05 AM", "03:40 AM", "04:15 AM", "04:50 AM",
		...
		JSQ_TTRD_VIA_HOB_SUN_HOL(
			new Station[] { Station.JournalSquare, Station.GroveSt,
					...
					Station.Nineth, Station.Fourteenth, Station.TwentyThird,
					Station.ThirtyThird }, new String[] { "12:00 AM",
	...
	NWK_WTC_SAT(
			...
			new String[] { "12:00 AM", "12:30 AM", "01:05 AM", "01:40 AM",
	...
	WTC_NWK_SAT(
			new Station[] { Station.WTC, Station.ExchangePlace,
					...
					Station.Newark }, new String[] { "12:00 AM", "12:35 AM",
	...
	WTC_NWK_WEEKDAY(
			new Station[] { Station.WTC, Station.ExchangePlace,
					Station.GroveSt, Station.JournalSquare, Station.Harrison,
					Station.Newark }, new String[] { "12:35 AM", "01:05 AM",
					...
					"10:22 PM", "10:37 PM", "10:52 PM", "11:07 PM", "11:22 PM",
					"11:37 PM", "11:57 PM" }, new int[] { 4, 3, 4, 9, 2 },
			ScheduleDay.Weekday);

	/**
	 * Constructs an instance of the train line object.
	 */
	private TrainLine(Station[] stations, String[] timeTable, int[] travelTimes, ScheduleDay scheduleDay) {
